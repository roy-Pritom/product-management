...
const AboutPage = () => {
  return (
    <div className="bg-gray-100 pb-10 pt-20 max-w-7xl mx-auto">
        ...
        <section className="mb-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
            <div className="text-center">
              <img className="w-24 h-24 rounded-full mx-auto mb-4" src="https://img.freepik.com/free-photo/cheerful-indian-businessman-smiling-closeup-portrait-jobs-career-campaign_53876-129417.jpg?t=st=1716731583~exp=1716735183~hmac=2a083e28236e08e1704a2356cf8940d039d3cfc4ee14296d52a2e0ec5e5370a0&w=996" alt="Team Member 1" />
              <h3 className="text-xl font-bold text-gray-900">John Doe</h3>
              <p className="text-gray-700">CEO & Founder</p>
            </div>
            <div className="text-center">
              <img className="w-24 h-24 rounded-full mx-auto mb-4" src="https://img.freepik.com/free-photo/portrait-man-laughing_23-2148859448.jpg?t=st=1716731943~exp=1716735543~hmac=9740fd84506346ece6452a3f1d8f592271c541994439e0f2b9cae36797f2fffc&w=740" alt="Team Member 2" />
              <h3 className="text-xl font-bold text-gray-900">Jane Smith</h3>
              <p className="text-gray-700">Chief Marketing Officer</p>
            </div>
            <div className="text-center">
              <img className="w-24 h-24 rounded-full mx-auto mb-4" src="https://img.freepik.com/free-photo/fashionable-young-woman-standing-front-blue-backdrop_23-2148204718.jpg?t=st=1716731765~exp=1716735365~hmac=9f10ad8fd66a661ef1cf715cc62ec63664bf4f3ccfdc090af0fb193bcaf0bf38&w=740" alt="Team Member 3"  />
